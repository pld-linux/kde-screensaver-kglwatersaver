...
Summary(pl.UTF-8):	KGLWaterSaver - oparty na OpenGL wygaszacz ekranu dla KDE
...
Wygaszacz ekranu dla KDE wykorzystujący OpenGL do efektów wizualnych.
Możliwości:
- wybór między obrazkami lub aktualnym pulpitem do zatapiania pod wodą
- różne efekty: wir, bąbelki, deszcz
